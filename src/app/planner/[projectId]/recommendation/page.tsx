    ...
    <div className="animate-fade-in max-w-4xl mx-auto">
      ...
      <div className="flex flex-col gap-8">
        ...
        {recommendation.riskWarnings.length > 0 && (
          <div className="glass-card-static p-5 border-rose-500/20 bg-rose-950/10 flex flex-col gap-3">
            <h3 className="font-semibold text-rose-400 text-sm sm:text-base flex items-center gap-2">
              <ShieldAlert className="w-5 h-5" />
              Technical Risk Factors
            </h3>
            <ul className="flex flex-col gap-2 pl-2">
              {recommendation.riskWarnings.map((warning, idx) => (
                <li key={idx} className="flex gap-2 text-xs text-rose-300 leading-relaxed">
